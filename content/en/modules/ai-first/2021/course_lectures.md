---
title: AI-First Engeneering Cybertraining Spring 2021 
weight: 4
draft: false
description: >
...
* Post a **professional** three paragraph Bio on
  ...
  under the folder bio. Use as subject "Bio: Lastname,
  Firstname". Research what a professional Biography is. Remember to
  write it in 3rd person and focus on professional activities. Look up
  the Bios from Geoffrey or Gregor as examples.
...
These introduce Colab with examples and a Homework using Colab for
deep learning. Please study videos and do homework.
